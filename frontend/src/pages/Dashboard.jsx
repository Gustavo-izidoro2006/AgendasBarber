          ...
          <header style={{
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <button
                  onClick={() => {
                    const linkUnico = `${window.location.origin}/Barbeariav2/${barbearia?.slug}`;
                  ...
                  <tbody>
                    {servicosState.length === 0 ? (
                      ...
                      >
                        ...
                        <td style={{ ...TABLE_TD, color: "var(--text-secondary)" }}>{s.duracao || s.duracaoMin || "—"} min</td>
                        <td style={{ ...TABLE_TD, fontWeight: 700, color: "var(--gold)" }}>R$ {(s.valor || s.preco || "0").toFixed(2).replace(".", ",")}</td>
                        <td style={TABLE_TD}>
